...
from . import u2Detect

wipFolderPath = r"./workspace/"
...
def alpha_matting_cutout(
    ...
    #result.save(wipFolderPath + "rawmaskoverlay.png")

    mask_new = Image.fromarray(mask)
    #mask_new.save(wipFolderPath + "rawmask.png")
    ...
    #trimapImg.save(wipFolderPath + "trimap.png")
    ...
    #cutoutImg.save(wipFolderPath + "cutout.png")
...
def get_model(model_name):
    if model_name == "u2netp":
        return u2Detect.load_model(model_name="u2netp")
    if model_name == "u2net_human_seg":
        return u2Detect.load_model(model_name="u2net_human_seg")
    else:
        return u2Detect.load_model(model_name="u2net")
...
def remove(
    ...
    mask = u2Detect.predict(model, np.array(im_output)).convert("L")
